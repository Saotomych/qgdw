...
int desclist;	// Descriptor for listen
...
//					ret = bind(desclist, (struct sockaddr *) &pr->sai, sizeof(struct sockaddr));
//					if (ret){
...
//			    			rdlen = accept(pr->socdesc, NULL, NULL);
//			    			if (rdlen == -1){
