...
//			printf("MFI %s: connect to working channel... ",appname);
			...
			if (!ep){
				printf("MFI %s error: New endpoint don't found for work\n", appname);
				return -1;
			}
