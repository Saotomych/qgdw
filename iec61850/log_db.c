...
int log_db_export_data(DB *db_req, time_t cut_time, char *db_file_out)
{
	...
	ts_sprintf(db_file_out, "%s%s%s%d%s", LOG_DB_ENV_DIR, db_req->dname, "_", cut_time, ".db");
